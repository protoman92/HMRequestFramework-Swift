...
public protocol SingletonType {
  ...
  var reduxStore: RxTreeStore<Any> { get }
...
public final class Singleton: SingletonType {
  ...
  fileprivate let _reduxStore: RxTreeStore<Any>
  ...
  public var reduxStore: RxTreeStore<Any> {
    return _reduxStore
  }
  ...
  private init(_ storeType: HMCDStoreSettings.StoreType) {
    ...
    _reduxStore = RxTreeStore<Any>.createInstance(ReduxReducer.reducer)
